                        ...
                        <div class="table-responsive text-nowrap">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php 
                                    $index = 0;
                                    foreach ($orderrequestcancel as $order) { 
                                    $index = $index + 1;    
                                    ?>
                                    <tr>
										...
										<a type="button"
                                            ...
                                            href="?route=approve&userid=<?php echo $order->getUser()->getUserId() ?>&orderid=<?php echo $order->getOrderId() ?>">Duyệt</a>

                                        <a type="button"
                                            class="btn rounded-pill btn-danger"
                                            href="?route=deleterequest&userid=<?php echo $order->getUser()->getUserId() ?>&orderid=<?php echo $order->getOrderId() ?>">Hủy</a>
                                        <?php endif ?>
                                    </tr>
                                    <?php } ?>
                                </tbody>
