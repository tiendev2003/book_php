				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <form action="?route=doaddproduct" method="post" enctype="multipart/form-data">
										...
										<?php endif; ?>
                                            <div class="card-body">
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="col mb-0">
                                                            <input type="text" class="form-control" id="bookname" value="" name="bookname"/>
                                                        </div> 
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="genreid" class="form-control" id="genreid">
                                                            ...
                                                            <?php foreach($listgenre as $genre): ?>
                                                                <option value="<?php echo $genre->getGenreid() ?>"><?php echo $genre->getCate()->getCatename() . " - " . $genre->getGenrename() ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Số lượng *</label> 
                                                        <input type="number" class="form-control" id="quantity" value="" name="quantity" placeholder=""/>
                                                    </div>
                                                    <div class="row g-2">
                                                        <div class="col mb-0">
                                                        <label class="form-label" for="basic-default-fullname">Giá mua *</label>
                                                            <input type="number" class="form-control" id="costprice" value="" name="costprice"/>
                                                        </div>
                                                        <div class="col mb-0">
                                                        <label class="form-label" for="basic-default-fullname">Giá bán *</label>
                                                            <input type="number" class="form-control" id="saleprice" value="" name="saleprice"/>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Nhà cung cấp </label> 
                                                        <input type="text" class="form-control" id="c_odate" value="" name="distributor" placeholder=""/>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Nhà  xuất bản </label> 
                                                        <input type="text" class="form-control" id="c_odate" value="" name="publisher" placeholder=""/>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Tác giả </label> 
                                                        <input type="text" class="form-control" id="c_odate" value="" name="author" placeholder=""/>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Dịch giả </label> 
                                                        <input type="text" class="form-control" id="c_odate" value="" name="translator" placeholder="" />
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Năm  </label> 
                                                        <input type="text" class="form-control" id="c_odate" value="" name="year" placeholder="" />
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Kích thước  </label> 
                                                        <input type="text" class="form-control" id="c_odate" value="" name="size" placeholder="" />
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Số trang </label> 
                                                        <input type="number" class="form-control" id="c_odate" value="" name="pages" placeholder="" />
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="basic-default-fullname">Cân nặng </label> 
                                                        <input type="number" class="form-control" id="c_odate" value="" name="weight" placeholder="" />
                                                    </div>
                                ...
                                <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="c_weight" name="description" rows="23"></textarea>
                                            </div>
                                        </div>
                            ...
                            <button type="submit" class="btn btn-outline-primary"  onclick="return checkProduct()">Thêm sản phẩm </button>
                        </form>
...
function checkProduct(){
    ...
    if(bookname.value.length == 0 || quantity.value.length == 0 || costprice.value.length == 0 || saleprice.value.length == 0 || genreid.value == "null" || image.files.length == 0){
