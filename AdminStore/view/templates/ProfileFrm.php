                            ...
                            <div class="col-12 col-lg-7 order-2 order-md-3 order-lg-2 mb-4">
                                <div class="col-xl">
                                    <div class="card mb-4">
                                        ...
                                        <?php if (isset($successprofile)): ?>
											<div class="alert alert-success" role="alert">
												<?php echo htmlspecialchars($successprofile); ?>
											</div>
										<?php endif; ?>
                                        <div class="card-body">
                                            <form th:action="" method="post">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col mb-0">
                                                        <input type="text" class="form-control" id="customer_fname" value="<?php echo $user->getFullName() ?>" name="customer_fname" readonly/>
                                                    </div> 
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <label class="form-label" for="basic-default-fullname">Email </label>
                                                        <input type="text" class="form-control" id="c_country" value="<?php echo $user->getEmail() ?>" name="c_country" readonly/>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                    <label class="form-label" for="basic-default-fullname">Thành phố </label>
                                                        <input type="text" class="form-control" id="c_country" value="<?php echo $user->getCity() ?>" name="c_country" readonly/>
                                                    </div>
                                                    <div class="col mb-0">
                                                    <label class="form-label" for="basic-default-fullname">Huyện </label>
                                                        <input type="text" class="form-control" id="customer_add" value="<?php echo $user->getDistrict() ?>" name="customer_add" readonly/>
                                                    </div>
                                                </div>
                                                <div class="row g-2">
                                                    <div class="col mb-0">
                                                ...
                                                <br>
                                                <a href="?route=profileedit" class="btn btn-primary" href="">Sửa thông tin</a>
                                            </form>
                                        </div>
