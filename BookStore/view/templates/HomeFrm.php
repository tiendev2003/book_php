    ...
    <body>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-secondary">100% sách mới </h4>
                        <h1 class="mb-5 display-3 text-primary">Cửa hàng Sach021</h1>
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="https://static.tramdoc.vn/image/img.news/0/0/0/275.jpg?v=1&w=480&h=295&nocache=1" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                    <!-- <a href="#" class="btn px-4 py-2 text-white rounded">Fruites</a> -->
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="https://langnhincuocsong.edu.vn/wp-content/uploads/2021/07/hinh-anh-cuon-sach-dep-54-1024x576-1024x585.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                ...
                                <p class="mb-0">Cho đơn hàng trên 500.000VND</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                ...
                                <p class="mb-0">Thanh toán đảm bảo 100%</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                ...
                                <p class="mb-0">Được đổi trả trong vòng 30 ngày</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                            ...
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                ...
                                <li class="nav-item">
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                        <span class="text-dark" style="width: 130px;">CNTT</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-5">
                                        <span class="text-dark" style="width: 130px;">Thiếu nhi</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php foreach($listallbook as $book) : ?>
                        ...
                        <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php foreach($listbook_it as $book) : ?>
                                            <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="<?php echo $book->getImage() ?>" class="img-fluid w-100 rounded-top" alt="">
                        ...
                        <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php foreach($listbook_literature as $book) : ?>
                                            <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="<?php echo $book->getImage() ?>" class="img-fluid w-100 rounded-top" alt="">
                        ...
                        <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php foreach($listbook_economy as $book) : ?>
                                            <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="<?php echo $book->getImage() ?>" class="img-fluid w-100 rounded-top" alt="">
                        ...
                        <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php foreach($listbook_children as $book) : ?>
                                            <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="<?php echo $book->getImage() ?>" class="img-fluid w-100 rounded-top" alt="">
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <?php foreach($listbook_bestseller as $book): ?>
                    <div class="col-lg-6 col-xl-4">
                        <div class="p-4 rounded bg-light">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="<?php echo $book->getImage() ?>" class="img-fluid rounded-circle w-100" alt="">
                                </div>
                                <div class="col-6">
                                    <?php 
                                        // $bookName = $book->getBookName();
                                    ...
                                    ?>
                                    <a href="?route=bookdetail&bookid=<?php echo $book->getBookId() ?>" class="h5"><?php echo $shortenedName ?></a>
                                        <div class="d-flex my-3">
                                            <?php for($i=0; $i < round($book->getMediumStar()); $i++): ?>
                                            <i class="fa fa-star text-secondary"></i>
                                        <?php endfor ?>
                                        <?php for($i = round($book->getMediumStar()); $i < 5; $i++): ?>
                                            <i class="fa fa-star"></i>
                                        <?php endfor ?>
                                    </div>
                                    <h4 class="mb-3"><?php echo number_format($book->getSalePrice()) . 'đ' ?></h4>
                                    <a href="?route=addcartinbook&bookid=<?php echo $book->getBookId() ?>" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
