...
<body>
    ...
    <div class="container-fluid fruite py-5">  
        <div class="container py-5">
            <br>
            <form action="?route=dopasstemporary&username=<?php echo $username ?>" method="post">
                <div class="row g-4 justify-content-center" style="width: 40%; margin: auto; box-shadow: 0 1px 2px 0 rgb(60 64 67/ 10%), 0 2px 6px 2px rgb(60 64 67/ 15%); padding: 2vw;">
                    <h2 style="text-align: center; ">Mật khẩu tạm thời</h2>
                    <?php if(isset($error)): ?>
                    ...
                    <button type="submit" onclick="return checkregister()" class="btn btn-primary" style="width: 30%;">Tiếp theo</button>
